          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {card(<>
              ...
              <div style={{ position: 'relative' }}>
                <button onClick={() => setAgentOpen(p => !p)} style={{ width: '100%', padding: '11px 14px', borderRadius: 11, background: 'rgba(255,255,255,0.04)', border: `1px solid ${agentOpen ? '#6C5CE7' : 'rgba(255,255,255,0.08)'}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between', color: '#f8fafc', fontSize: 14, cursor: 'pointer', transition: 'border-color 0.2s' }}>
